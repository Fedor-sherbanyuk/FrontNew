<!--Зроби окрему функцію з визначення спортивного звання.-->
<!--Винеси функцію в окремий файл. Використай її визов в своїй функції яка обробляє DOM.-->
<!--Це має бути функція яка приймає параметри які необхідні для визначення.-->
<!--Всі оті кейси мають бути всередині-->

// <!--Функція має повертати спортивне звання (string)-->
function resultTitle(gender, weight, squatting, bench, deadlift) {
